...
Router.route('/subscribed', function () {
  Session.set("currentPageTitle", "Subscribed Forums")
...
Router.route('/mentions', function () {
  this.render('mentions');
});

Router.route('/mention', function () {
  this.render('mention', {
    data: function () {
      return Session.get("currentMention");
    }
  });
});

Router.route('/newpm', function () {
  this.render('newpm');
});
